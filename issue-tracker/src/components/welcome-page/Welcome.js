    ...
    <div className="body-welcome">
      <div className="main">
        ...
        <div className="register">
            ...
            <input className='welcome-input' type="text" id="fname" name="txt" placeholder="First Name" required onChange={(e) => formState.setFirstName(e.target.value)} value={formState.firstName} />
            <input className='welcome-input' type="text" id="lname" name="txt" placeholder="Last Name" required onChange={(e) => formState.setLastName(e.target.value)} value={formState.lastName} />
            <input className='welcome-input' type="text" name="txt" id="reg_username" placeholder="Username" required onChange={(e) => formState.setUsername(e.target.value)} value={formState.username} />
